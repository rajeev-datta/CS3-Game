...
STUDENT_LIBS = vector list polygon color body scene forces animate star collision tank powerup sound gameplay text screen_set images levels
...
LIBS = SDL2main.lib SDL2.lib SDL2_gfx.lib shell32.lib SDL2_ttf.lib SDL2_image.lib SDL2_mixer.lib
